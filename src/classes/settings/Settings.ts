...
export default class Settings implements ISettings{
    ...
    constructor(type?: SettingsLinksType, value?: string, number?: number) {
    ...
    async load(type: SettingsLinksType, res?: ISettings): Promise<Settings> {
        if (res) {
            this.type = type;
...
const querySQL = {
    settings: async (type: SettingsLinksType): Promise<ISettings> => {
