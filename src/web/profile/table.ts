...
<tr><td><b class="profileB">Имя:</b></td><td><b class="profileB">${user.info.name}</b></td><td><b class="profileB">|</b><form name="myForm1"><input class="inputP" type="text" id="nameUpdate" name="nameUpdate" required/></form></td></tr>
...
<tr><td><b class="profileB">Телеграм id:</b></td><td><b class="profileB">${user.info.id}</b></td><td><b class="profileB"><i>Указывайте в коментарии платежа</i></b></td></tr>
<tr><td><b class="profileB">Статус оплаты:</b></td><td><b class="profileB">${config.payment.get(user.payment.status)}</b></td><td><b class="profileB">Расчитать сумму оплаты на |<form name="myForm4"><input class="inputP" type="text" id="monthPay" name="monthPay" required/></form>месяцев</b></td></tr>
<tr><td><b class="profileB">Сумма оплаты с учетом рефералки:</b></td><td><b class="profileB">${Math.floor(user.payment.price - (user.payment.price * (refBonus / 100)))}р</b></td><td><b class="profileB"><a href="https://www.tinkoff.ru/rm/korop.aleksandr4/KHtiD43274">Перейти на страницу оплаты</a></b></td></tr>
<tr><td><b class="profileB">Реферальный ключ:</b></td><td><b class="profileB">${user.payment.referral.key}</b></td><td><b class="profileB">|</b><form name="myForm3"><input class="inputP" type="text" id="refKey" name="refKey" required/></form></td></tr>
